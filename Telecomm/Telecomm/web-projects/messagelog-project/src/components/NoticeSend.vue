...
<template>
    <div>
        ...
        <div @click="OpenLink()" style="width: 280px;height: 180px; margin-top: 5px; margin-left:16px; display: inline-block; cursor:pointer;">
            <div style="width: 280px;height: 120px;16px;position: relative;margin-left;">
