                ...
                <ul class=''>
                    ...
                    <li>
                        <div class='triangle-right right' style='cursor: pointer;' @click='playAudio()'>
                            {{model.nDuration}}″&emsp;
                            <!-- 隐藏显示gif，不然的话快速切换显示gif时gif停在第一帧，原因不明 -->
                           <img v-show='false' src='qrc:/html/image/Resources/html/image/voice.gif'/>
                            <img v-if='isPlaying' style='margin-top:2px; transform: rotateY(-180deg);' src='qrc:/html/image/Resources/html/image/voice.gif' width='20px' />
                            <img v-if='!isPlaying' style='margin-top:2px; transform: rotateY(-180deg);' src='qrc:/html/image/Resources/html/image/voice.png' width='20px' />
