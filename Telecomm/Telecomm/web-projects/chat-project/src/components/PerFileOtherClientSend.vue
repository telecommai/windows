                                ...
                                <div class='lb' style="height:60px;">
                                    ...
                                    <div v-if='!isLocaleRu' class='btn'>
                                        <ul :id="model.strUlID" style="margin:0 auto">
                                            <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:15px" @click="getOtherFile()" v-if='model.OperateFlag == 0'>{{$t("file.save")}}</li>
                                            <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:15px" @click="getOtherFile()" v-if='model.OperateFlag == 2'>{{$t("file.open")}}</li>
                                    ...
                                    <div v-if='isLocaleRu' class='btn'>
                                        <ul :id="model.strUlID" style="margin:0 auto">
                                            <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="getOtherFile()" v-if='model.OperateFlag == 0'>{{$t("file.save")}}</li>
                                            <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="getOtherFile()" v-if='model.OperateFlag == 2'>{{$t("file.open")}}</li>
