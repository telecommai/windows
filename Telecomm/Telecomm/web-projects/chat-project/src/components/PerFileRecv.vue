                    ...
                    <div class='lb' style="height:60px;">
                        <div>
                            ...
                            <div class='namesta' style="height:64px;margin:0 auto;">
                                <ul :id="model.strUlID2" style="margin:0px auto;padding-left:15px;">
                                    <li style='font-size:12px;height:30px;margin-top:10px;color:black' :title="model.FileName">{{model.strFileName}} {{model.strSize}} </li>
                        ...
                        <div v-if='!isLocaleRu' class='btn'>
                            <ul :id="model.strUlID" style="margin:0 auto">
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:30px" @click="getFile()" v-if='model.OperateFlag == 0'>{{$t("file.save")}}</li>
								<li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:30px" @click="getFile()" v-if='model.OperateFlag == 3'>{{$t("file.reSave")}}</li>
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:30px" @click="getFile()" v-if='model.OperateFlag == 2'>{{$t("file.open")}}</li>
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:30px" @click="saveFile()" v-if='model.OperateFlag == 0'>{{$t("file.saveAs")}}</li>
								<li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:30px" @click="saveFile()" v-if='model.OperateFlag == 3'>{{$t("file.saveAs")}}</li>
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:30px" @click="saveFile()" v-if='model.OperateFlag == 1'>{{$t("file.cancel")}}</li>
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:30px" @click="saveFile()" v-if='model.OperateFlag == 2'>{{$t("file.openDir")}}</li>
                            </ul>
                        </div>
						<div v-if='isLocaleRu' class='btn'>
                            <ul :id="model.strUlID" style="margin:0 auto">
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="getFile()" v-if='model.OperateFlag == 0'>{{$t("file.save")}}</li>
								<li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="getFile()" v-if='model.OperateFlag == 3'>{{$t("file.reSave")}}</li>
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="getFile()" v-if='model.OperateFlag == 2'>{{$t("file.open")}}</li>
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="saveFile()" v-if='model.OperateFlag == 0'>{{$t("file.saveAs")}}</li>
								<li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="saveFile()" v-if='model.OperateFlag == 3'>{{$t("file.saveAs")}}</li>
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="saveFile()" v-if='model.OperateFlag == 1'>{{$t("file.cancel")}}</li>
                                <li style="font-size:12px;cursor:hand;padding-top:15px;color:#0000ff;padding-right:5px" @click="saveFile()" v-if='model.OperateFlag == 2'>{{$t("file.openDir")}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
