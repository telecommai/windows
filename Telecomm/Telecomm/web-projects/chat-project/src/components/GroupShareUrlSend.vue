                    ...
                    <li>
                        <div @click='OpenLink()' style="width: 240px;height: 90px; margin-top: 5px; position:relative; float:left; display: inline-block; cursor:pointer;">
                            <div style="width: 240px;height: 80px;border-radius: 10px; background-color: white; position: relative;">
                                ...
                                <div>
                                    <p style='display: block; margin:0; padding:10px; padding-bottom:5px;text-overflow: ellipsis;white-space: nowrap;overflow: hidden;'>
                                        {{model.subject}}
                                    </p>
                                    <p style='display: block; margin:0; color: grey;word-break: break-all; font-size:12px; padding:10px; padding-top:0; line-height:18px; overflow: hidden;height:30px;'>
                                        {{model.text}}
                                    </p>
                                </div>
                            </div>
