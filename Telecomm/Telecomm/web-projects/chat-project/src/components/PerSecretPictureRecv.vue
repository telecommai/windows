...
<template>
    <div :id="model.strMsgID" style='overflow:hidden;'>
        <p class='divotherhead' @click='openProfile()'>
            ...
            style='max-width:200px;max-height:200px;width:200px; height:131px; margin-bottom:10px; float:left;cursor:pointer' />
            <div style="position: absolute;left: 70px;color: white;font-size:14px;top: 103px;line-height: 30px;">{{$t("secret.picture")}}
                            </div>
          </div>
