...
QT_MOC_LITERAL(1, 14, 14), // "sigClickedDock"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 19) // "sigGlobalMouseMouse"

    },
    "myApplication\0sigClickedDock\0\0"
    "sigGlobalMouseMouse"
};
...
void myApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigClickedDock(); break;
        case 1: _t->sigGlobalMouseMouse(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myApplication::sigClickedDock)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (myApplication::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myApplication::sigGlobalMouseMouse)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myApplication::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_myApplication.data,
      qt_meta_data_myApplication,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void myApplication::sigClickedDock()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void myApplication::sigGlobalMouseMouse()
{
